! ---------------------------------------------------------------------- !
!  COMPILE USING
!   f2py -m parallel_int_field_for -c parallel_interp_field_for.f90 -fopenmp --fcompiler=gfortran -lgomp
...
!$omp parallel do &
!$omp& private(p, fi, fj, i, j, hx, hy, tmpx00, tmpx10, tmpx01, tmpx11, tmpy00, tmpy10, tmpy01, tmpy11) &
!$omp& shared(xn, yn, bias_x, bias_y, dx, dy, efx, efy, Nxg, Nyg, Ex_n, Ey_n)
do p=1,N_mp
