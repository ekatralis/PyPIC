!---------------------------------------------------------------------- !
! COMPILE USING
!  f2py -m parallel_int_field_for_border -c parallel_interp_field_for_with_border.f90 -fopenmp --fcompiler=gfortran -lgomp
...
!$omp parallel do &
!$omp& private(p, fi, fj, hx, hy, i, j, anyexternal, wei_ij, wei_i1j, wei_ij1, &
!$omp& wei_i1j1, fact_correct, tmpx00, tmpx10, tmpx01, tmpx11, tmpy00, tmpy10, tmpy01, tmpy11)&
!$omp& shared(xn, yn, bias_x, bias_y, dx, dy, efx, efy, Nxg, Nyg, inside_mat, Ex_n, Ey_n)
do p=1,N_mp
